...
const PictureStep1 = () => {
  ...
  return (
    <SafeAreaView>
      ...
      />
      <View>
        <Text style={styles.Title}>Step 1: Spread Your Arms</Text>
      </View>
      <View>
        <Image 
          style={styles.ImageStyle}
          source={require('../../asserts/images/giang_2_tay.png')}/>
      </View>
      <View style={{flexDirection: 'row', justifyContent: 'space-around'}}>
            ...
            <TouchableOpacity onPress={() => {navigation.navigate('PictureStep2')}}
