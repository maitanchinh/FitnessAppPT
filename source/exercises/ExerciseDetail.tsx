        ...
        <View style={styles.body}>
          <ScrollView horizontal={false}>
            ...
            <Text style={{fontSize: 16, color: '#707070'}}>
              Easy | {this.props.route.params.calo} calories
            </Text>
            <Text
              style={{
                fontSize: 22,
            ...
            <Text style={{fontSize: 16, color: '#707070'}}>
              An exercise in which a standing person jumps to a position with
              the legs and arm spread out and then jumps back to the original
              position
            </Text>
            <View
              style={{
